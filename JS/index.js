...
const classes = document.getElementById("education_section");

function JLHS_bg_change() {
    classes.style.backgroundImage = "url('./imgs/JLHS_Colt2.png')";
}
function JLHS_bg_revert() {
    classes.style.backgroundImage = "url('./imgs/cap_n_books.png')";
}

function UCD_bg_change() {
    classes.style.backgroundImage = "url('./imgs/UCD_mustang.png')";
}

function UCD_bg_revert() {
    classes.style.backgroundImage = "url('./imgs/cap_n_books.png')";
}

function ohlone_bg_change() {
    classes.style.backgroundImage = "url('./imgs/Ohlone_logo.jpg')";
}

function ohlone_bg_revert() {
    classes.style.backgroundImage = "url('./imgs/cap_n_books.png')";
}
